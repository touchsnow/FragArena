import { _decorator, Node, EventHandler, ButtonComponent, Color, find, instantiate, Prefab, Asset, loader, resources, director } from 'cc';
...
export default class UIUtility {
    ...
    loadRes(url: any, type: typeof Asset, progressCallback: (finish: number, total: number, item: any) => void, completeCallback: (error: Error, resource: any) => void): void {
        if (typeof resources != 'undefined') {
            resources.load(url, type, progressCallback, completeCallback);
        } else {
