...
@ccclass('DynamiteBombObject')
export class DynamiteBombObject extends PoolObjLifeCycle {
    ...
    startLife(callBack?) {
        ...
        FrangArenaAudioMgr.getInstance().playEffectByPath(this.node.worldPosition,"RockBomb")
    }
