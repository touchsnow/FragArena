...
@ccclass('TeslaBulletObject')
export class TeslaBulletObject extends PoolObjLifeCycle {
    ...
    startLife(callBack?) {
        ...
        FrangArenaAudioMgr.getInstance().playEffectByPath(this.node.worldPosition,"TeslaBomb")
    }
