import { _decorator, Node, resources, instantiate, find, Vec4 } from 'cc';
...
@ccclass('FlameGun')
export class FlameGun extends ContinuousGun {
    ...
    shot() {
        if (!this.bullet) {
            let node = instantiate(resources.get("Bullet/FlameBullet")) as Node
